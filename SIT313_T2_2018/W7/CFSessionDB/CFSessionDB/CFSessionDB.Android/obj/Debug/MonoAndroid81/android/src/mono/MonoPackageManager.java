...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "CFSessionDB.Android.dll" comes first in this list. */
		"CFSessionDB.Android.dll",
		"CFSessionDB.dll",
		"FormsViewGroup.dll",
		"MarcTron.Plugin.MTSql.Abstractions.dll",
		"MarcTron.Plugin.MTSql.dll",
		"SQLite-net.dll",
